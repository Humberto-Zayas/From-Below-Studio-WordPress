...
For more information about From Below Studio Theme please go to https://codex.wordpress.org/Twenty_Sixteen.

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Type in From Below Studio Theme in the search form and press the 'Enter' key on your keyboard.
...
From Below Studio Theme WordPress Theme, Copyright 2014-2015 WordPress.org
From Below Studio Theme is distributed under the terms of the GNU GPL
...
From Below Studio Theme Theme bundles the following third-party resources:
